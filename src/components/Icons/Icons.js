...
export const UserGroupActiveIcon = ({ width = '3.8rem', height = '3.8rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ExploreIcon = ({ width = '3.8rem', height = '3.8rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ExploreActiveIcon = ({ width = '3.8rem', height = '3.8rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const GoToHeadIcon = ({ width = '1.8rem', height = '1.8rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
